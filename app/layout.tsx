...
export const metadata: Metadata = {
  title: "Amorzin — crie um pedido de namoro que ela vai lembrar pra sempre ou crie um mensagem de amor para uma pessoa especial",
  description:
  ...
  openGraph: {
    title: "Amorzin — o pedido de namoro que se joga",
