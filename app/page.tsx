  ...
  return (
    <div className="min-h-screen bg-[#FFFCFA] font-sans text-[#35131F]">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-[1.05fr_0.95fr] md:gap-16">
          <div className="text-center md:text-left">
            <span className="mb-5 inline-flex items-center rounded-full border border-[#E6395B]/15 bg-white/80 px-3.5 py-1.5 text-[11px] font-medium text-[#E6395B] shadow-sm">
              💘 pedidos e surpresas de amor que se jogam
            </span>
            ...
            <h1 className="mx-auto mb-4 max-w-xl font-serif text-[32px] font-bold leading-[1.12] tracking-[-0.02em] text-[#35131F] md:mx-0 md:text-[48px]">
              Transforme um pedido ou uma surpresa em algo inesquecível
            </h1>

            <p className="mx-auto mb-7 max-w-lg text-[14px] leading-7 text-[#795C66] md:mx-0 md:text-[15px]">
              Peça namoro, comemore uma data especial ou simplesmente
              surpreenda quem você ama. Crie um jogo com suas fotos e
              mensagens, mande o link e acompanhe a reação em tempo real.
            </p>
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[10.5px] text-[#795C66]/70 md:justify-start">
              ...
              <span className="hidden text-[#35131F]/20 sm:inline">•</span>
          ...
          {/* GAME PREVIEW — sem mudanças, o jogo em si continua igual */}
          <div className="relative flex justify-center md:justify-end">
            ...
            <div className="relative">
              <div className="absolute -left-16 top-16 z-20 hidden rounded-2xl border border-[#35131F]/[0.06] bg-white px-3 py-2 shadow-[0_10px_35px_rgba(53,19,31,0.10)] sm:block">
                <div className="text-[9px] font-bold text-[#35131F]">Seu jogo</div>
                <div className="mt-0.5 text-[8px] text-[#795C66]">feito com carinho 💘</div>
              </div>
                ...
                <div className="rounded-[31px] bg-[#150109] p-[6px] shadow-[0_30px_80px_rgba(53,19,31,0.28)]">
                  <div className="relative h-[370px] overflow-hidden rounded-[25px] bg-[radial-gradient(120%_60%_at_50%_0%,#55123a_0%,#3d0f2b_45%,#22051a_100%)]">
                    ...
                    <div className="absolute bottom-[7%] left-1/2 h-[90px] w-[105px] -translate-x-1/2">
                      <svg viewBox="0 0 118 100" className="h-full w-full drop-shadow-[0_6px_10px_rgba(0,0,0,0.5)]">
                        <defs>
                          <linearGradient id="landingBowGrad" x1="0" y1="0" x2="1" y2="0">
                            <stop offset="0%" stopColor="#a9721f" />
                            <stop offset="50%" stopColor="#f3d38a" />
                            <stop offset="100%" stopColor="#a9721f" />
                          </linearGradient>
                        </defs>
                        <path d="M0 65 Q59 83 118 65" fill="none" stroke="url(#landingBowGrad)" strokeWidth={6} strokeLinecap="round" />
                        <line x1={2} y1={65} x2={116} y2={65} stroke="#e9dcc9" strokeWidth={1.6} />
                        <line x1={59} y1={63} x2={59} y2={26} stroke="#c99a4e" strokeWidth={3} strokeLinecap="round" />
                        <path d="M59 20 L50 34 L68 34 Z" fill="#f3d38a" stroke="#a9721f" strokeWidth={0.6} />
                      </svg>
                    </div>

                    <div className="absolute bottom-[6%] left-1/2 -translate-x-1/2 translate-y-6 text-[#f3d38a]">▼</div>
                    <div className="absolute bottom-3 left-0 right-0 text-center text-[7px] text-[#fbeee0]/35">arraste para mirar</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -right-14 top-28 hidden rotate-3 rounded-2xl border border-[#35131F]/[0.06] bg-white px-3 py-2 shadow-[0_10px_35px_rgba(53,19,31,0.10)] sm:block">
                <div className="text-[8px] text-[#795C66]">quase lá...</div>
                <div className="mt-0.5 text-[9px] font-bold text-[#E6395B]">💘 5 acertos</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* =========================================================
          COMO FUNCIONA
      ========================================================== */}
      <section id="como-funciona" className="px-5 py-14 md:px-10 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-10 max-w-xl text-center md:mb-12">
            <div className="mb-2 text-[10px] font-bold tracking-[0.15em] text-[#E6395B]">COMO FUNCIONA</div>
            <h2 className="font-serif text-2xl font-bold text-[#35131F] md:text-3xl">Você cria. A outra pessoa joga.</h2>
            <p className="mt-2 text-xs leading-6 text-[#795C66] md:text-sm">
              Transforme um pedido ou uma surpresa em uma pequena aventura feita só para vocês.
            </p>
          </div>
            ...
            {[
              {
                number: "01",
                icon: "💌",
                title: "Escolha o motivo e as fotos",
                desc: "Pedido, surpresa ou data especial — e os momentos que contam a história de vocês.",
              },
              {
                number: "02",
                icon: "💬",
                title: "Escreva suas mensagens",
                desc: "Crie desafios, pistas e a mensagem final, do jeito que combina com o momento.",
              },
              {
                number: "03",
                icon: "🔗",
              ...
              >
                <div className="mb-5 flex items-center justify-between">
                  ...
                  <span className="font-serif text-xs font-bold text-[#E6395B]/30">{step.number}</span>
                </div>
                <div className="mb-1 text-sm font-bold text-[#35131F]">{step.title}</div>
                <div className="text-xs leading-6 text-[#795C66]">{step.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-white px-5 py-14 md:px-10 md:py-20">
        <div className="mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-2 md:gap-16">
          <div className="order-2 flex justify-center md:order-1">
            <div className="relative w-full max-w-md">
              <div className="rounded-3xl border border-[#35131F]/[0.07] bg-[#FFF5F7] p-6 shadow-[0_20px_60px_rgba(53,19,31,0.07)] md:p-8">
                <div className="mb-5 flex items-center justify-between">
                  <div>
                    <div className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#E6395B]">Seu Amorzin</div>
                    <div className="mt-1 font-serif text-lg font-bold text-[#35131F]">Uma experiência só de vocês</div>
                  </div>
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white shadow-sm">💌</div>
                </div>

                <div className="grid grid-cols-3 gap-2">
                  <div className="aspect-square rounded-xl bg-[radial-gradient(circle_at_35%_30%,#ffd9e6,#f3a8c4_45%,#b8577f_100%)] flex items-center justify-center text-2xl">🥰</div>
                  <div className="aspect-square rounded-xl bg-[radial-gradient(circle_at_35%_30%,#ffd9e6,#f3a8c4_45%,#b8577f_100%)] flex items-center justify-center text-2xl">💞</div>
                  <div className="aspect-square rounded-xl bg-[radial-gradient(circle_at_35%_30%,#ffd9e6,#f3a8c4_45%,#b8577f_100%)] flex items-center justify-center text-2xl">💗</div>
                </div>
                ...
                <div className="mt-5 rounded-2xl border border-white bg-white p-4">
                  <div className="flex items-center justify-between text-[10px]">
                    <span className="font-semibold text-[#35131F]">Progresso</span>
                    <span className="font-semibold text-[#E6395B]">5 / 8</span>
                  </div>
          ...
          <div className="order-1 md:order-2">
            <div className="mb-2 text-[10px] font-bold tracking-[0.15em] text-[#E6395B]">FEITO PARA SER ESPECIAL</div>
            ...
            <p className="mt-4 max-w-lg text-[13px] leading-7 text-[#795C66] md:text-sm">
              O Amorzin transforma aquele momento importante em uma experiência
              interativa — seja pra pedir alguém em namoro, seja pra surpreender
              quem você já ama. A pessoa joga, relembra momentos e chega ao final
              sem saber exatamente o que está por vir.
            </p>

            <div className="mt-6 space-y-3">
              {[
                { icon: "💗", title: "Personalizado", desc: "Fotos e mensagens que contam a história de vocês." },
                { icon: "🏹", title: "Interativo", desc: "A pessoa participa do momento em vez de apenas ler." },
                { icon: "💌", title: "Compartilhável", desc: "É só enviar o link pelo WhatsApp ou onde quiser." },
              ].map((item) => (
                <div key={item.title} className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs font-bold text-[#35131F]">{item.title}</div>
                    <div className="mt-0.5 text-[11px] leading-5 text-[#795C66]">{item.desc}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* =========================================================
          PLANOS — atualizado pro modelo atual (Básico/Super por jogo,
          Premium virou conta paga, não mais "por jogo")
      ========================================================== */}
      <section id="planos" className="border-y border-[#35131F]/[0.05] bg-[#FFF5F7] px-5 py-14 md:px-10 md:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-9 max-w-xl text-center md:mb-11">
            <div className="mb-2 text-[10px] font-bold tracking-[0.15em] text-[#E6395B]">PLANOS</div>
            <h2 className="font-serif text-2xl font-bold text-[#35131F] md:text-3xl">
              Pague só o que precisar. Ou vire Premium.
            </h2>
            <p className="mt-2 text-xs leading-6 text-[#795C66] md:text-sm">
              Básico e Super são por jogo, sem precisar de cadastro. Premium é uma
              conta — paga uma vez, cria quantos Amorzins quiser depois.
            </p>
          </div>
          ...
          <div className="grid items-start gap-4 md:grid-cols-3 md:gap-5">
            ...
            <PlanCard
              ...
              features={[
                ...
                "sem pagar de novo por cada um",
                "link sem expirar",
                "painel pra gerenciar tudo",
              ]}
              note="requer conta"
            />
          </div>
          ...
          <div className="mt-8 text-center">
            <button
              type="button"
              onClick={() => router.push('/criar')}
              className="rounded-full bg-[#E6395B] px-7 py-3 text-xs font-bold text-white shadow-[0_8px_25px_rgba(230,57,91,0.20)] transition-all hover:-translate-y-0.5 hover:bg-[#C92F4D]"
            >
              Começar agora
            </button>
            <p className="mt-3 text-[10px] text-[#795C66]/60">
              Você escolhe o plano depois de ver o jogo pronto — nada de pagar antes de ver o resultado.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden px-5 py-16 text-center md:px-10 md:py-24">
        ...
        <div className="relative mx-auto max-w-xl">
          ...
          <h2 className="font-serif text-2xl font-bold leading-tight text-[#35131F] md:text-3xl">
            Transforme seu momento em uma história.
          </h2>
          <p className="mx-auto mt-3 max-w-md text-[13px] leading-6 text-[#795C66] md:text-sm">
            Leva menos de 5 minutos para criar uma experiência que a outra
            pessoa não vai esquecer.
          </p>
      ...
      <footer className="border-t border-[#35131F]/[0.06] bg-white px-5 py-5 md:px-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 md:flex-row">
          <div className="font-serif text-xs font-bold text-[#35131F]">🏹 Amorzin</div>
          <div className="text-center text-[10px] text-[#795C66]/60">
            Feito com ❤️ para histórias que merecem ser lembradas.
          </div>
          <div className="flex items-center gap-3 text-[10px] text-[#795C66]/50">
            <a href="termos-de-uso" className="hover:text-[#E6395B]">Termos</a>
            <span>·</span>
            <a href="/privacidade" className="hover:text-[#E6395B]">Privacidade</a>
            <span>·</span>
            <span>© Amorzin</span>
          </div>
        </div>
...
function PlanCard({ title, price, suffix, features, note, highlighted }: PlanCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="mb-1 flex items-center justify-between">
        <div className="text-xs font-bold text-[#35131F]">{title}</div>
        {highlighted && <span className="text-sm">💗</span>}
      </div>

      <div className="mb-4">
        <span className="text-2xl font-bold tracking-tight text-[#35131F] md:text-3xl">{price}</span>
        {suffix && <span className="ml-1 text-[10px] text-[#795C66]">{suffix}</span>}
      </div>

      <div className={`space-y-2 text-[11px] leading-relaxed md:text-xs ${highlighted ? "text-[#35131F]/80" : "text-[#795C66]"}`}>
        {features.map((feature) => (
          <div key={feature} className="flex items-start gap-2">
            <span
              className={`mt-px flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full text-[9px] font-bold ${
                highlighted ? "bg-[#FFE8EE] text-[#E6395B]" : "bg-[#35131F]/[0.05] text-[#795C66]"
              }`}
            >
              ✓
            </span>
        ...
        {note && (
          <div className="flex items-start gap-2 pt-1 text-[#795C66]/70">
            <span className="mt-px flex h-4 w-4 flex-shrink-0 items-center justify-center text-[9px]">·</span>
            <span>{note}</span>
          </div>
        )}
      </div>
